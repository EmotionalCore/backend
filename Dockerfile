...
ENV GOOGLE_REDIRECT_URI=https://localhost:3000/login/oauth2/code/google
...
ENV NAVER_REDIRECT_URI=https://localhost:3000/signin/naver
ENV NAVER_CLIENT_ID=MN6cUHxKhmM0Ki3Bp6ry
ENV NAVER_CLIENT_SECRET=k_UiUuhUEj

ENV KAKAO_REDIRECT_URI=http://localhost:3000/auth/oauth2/kakao
